...
export const ServicesPage: React.FC = () => {
  ...
  return (
    <div className="dropdown-content-page flex flex-col min-h-screen bg-[#F1F3F5] pt-24">
      ...
      {downloadNotice && (
        <div className={`fixed bottom-8 right-8 z-50 text-white px-6 py-4 border shadow-2xl flex items-center gap-3 animate-fade-in rounded-md ${downloadNotice.ok ? 'bg-[#2A4C72] border-[#3E4C60]' : 'bg-[#7A2E22] border-[#A5442F]'}`}>
          {downloadNotice.ok ? (
      ...
      <section ref={divisionsSectionRef} className="dropdown-scroll-content py-20 scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-[#2A4C72] mt-1">Our Professional Divisions</h2>
          </div>
            ...
            {paginatedServices.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-56 overflow-hidden bg-[#2A4C72]">
                    <img 
                      src={service.image} 
                      alt={service.title}
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#2A4C72] via-[#2A4C72]/40 to-transparent opacity-80 group-hover:opacity-60 transition-opacity"></div>
                    
                    <div className="absolute top-4 left-4 z-10">
                      <span className="text-[10px] font-mono bg-[#2A4C72]/80 backdrop-blur-md text-[#D6C489] border border-[#A49050]/40 px-3 py-1 rounded font-bold uppercase tracking-widest">
                  ...
                  <div className="p-6 flex flex-col flex-1 justify-between gap-6">
                    <p className="text-xs sm:text-sm text-[#2A4C72]/75 leading-relaxed font-light">
                      {service.shortDesc}
                    </p>
                    ...
                    <div className="pt-4 border-t border-gray-100 flex items-center gap-3">
                      <button
                        ...
                        className="flex-1 bg-[#2A4C72] hover:bg-[#3E4C60] hover:text-[#D6C489] text-white py-2.5 px-4 text-xs font-mono font-bold tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-2 rounded-md shadow hover:shadow-md group-hover:bg-[#3E4C60] group-hover:text-[#D6C489]"
                      >
                      ...
                      <button
                        ...
                        className="p-2.5 bg-[#F1F3F5] hover:bg-[#A49050]/20 text-[#2A4C72] border border-[#A49050]/30 transition-all duration-300 rounded-md hover:border-[#2A4C72] cursor-pointer"
      ...
      {selectedService && (
        <div key={selectedService.id} className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-[#2A4C72]/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-white w-full max-w-6xl md:h-[85vh] max-h-[92vh] rounded-3xl shadow-2xl relative flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="service-modal-image-panel relative w-full h-56 md:h-full md:w-[42%] shrink-0 overflow-hidden">
              <img
                ...
                referrerPolicy="no-referrer"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#2A4C72]/60 via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-[#2A4C72]/15"></div>
            </div>
            ...
            <div className="service-modal-content-panel flex-1 flex flex-col justify-between overflow-hidden">
              ...
              <div className="px-6 pt-6 pb-3 sm:px-8 sm:pt-8 sm:pb-3.5 border-b border-gray-100 shrink-0">
                ...
                <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#2A4C72]">
              ...
              <div className="px-6 py-4 sm:px-8 sm:py-5 overflow-y-auto space-y-5 flex-1">
                ...
                <div className="space-y-2">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-[#2A4C72] border-b border-gray-200 pb-1.5">
                    Overview
                  </h4>
                  <p className="text-sm text-[#2A4C72]/75 leading-relaxed">
                  ...
                  <ul className="space-y-1.5 text-xs">
                    {selectedService.deliverables.map((del, dIdx) => (
                      <li key={dIdx} className="flex items-start gap-2">
                        ...
                        <span className="font-medium text-[#2A4C72]/90 leading-relaxed">{del}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <p className="text-sm text-[#2A4C72]/75 leading-relaxed bg-[#F1F3F5] p-3.5 rounded-sm">
              ...
              <div className="flex items-center justify-end gap-3 px-6 sm:px-10 py-5 border-t border-gray-100 bg-[#F1F3F5]/50 shrink-0">
                <button
                  onClick={() => setSelectedService(null)}
                  className="px-5 py-2.5 text-sm font-medium text-[#2A4C72] hover:bg-gray-100 rounded-full transition-colors cursor-pointer"
                >
                  Close
                </button>
                <button
                  onClick={() => handleDownloadBrochure(selectedService)}
                  className="px-6 py-2.5 bg-[#3E4C60] hover:bg-[#2A4C72] text-white hover:text-[#D6C489] text-sm font-medium rounded-full shadow-md hover:shadow-lg transition-all flex items-center gap-2 border border-[#A49050]/30 cursor-pointer"
                >
