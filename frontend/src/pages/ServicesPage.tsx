...
export const ServicesPage: React.FC = () => {
  ...
  return (
    <div className="dropdown-content-page flex flex-col min-h-screen bg-[#F1F3F5] pt-24">
      ...
      <section className="bg-[#53647D] text-white py-20 relative overflow-hidden border-b border-[#A49050]/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="dropdown-banner-copy flex flex-col gap-5 max-w-3xl">
            <span className="inline-flex w-fit items-center text-xs font-mono tracking-widest text-[#A49050] uppercase bg-[#A49050]/10 border border-[#A49050]/30 px-4 py-1.5 rounded-full">
            ...
            <h1 ref={heroHeadingRef} className="text-4xl sm:text-6xl font-serif font-bold tracking-tight text-white leading-tight">
              End-to-End <span className="text-[#A49050] italic font-medium">Infrastructure</span> Solutions
            </h1>
            <div
      ...
      {downloadNotice && (
        <div className="fixed bottom-8 right-8 z-50 bg-[#18253A] text-white px-6 py-4 border border-[#D96B33] shadow-2xl flex items-center gap-3 animate-fade-in rounded-md">
          <CheckCircle2 className="w-5 h-5 text-[#D96B33]" />
          <div>
      ...
      <section className="dropdown-scroll-content py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 pb-6 border-b border-[#A49050]/20">
            <span className="text-xs font-mono tracking-widest text-[#D96B33] uppercase">CORE CAPABILITIES</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICES.map((service, index) => (
              <div
                ...
                className="bg-white border border-[#A49050]/30 rounded-md overflow-hidden shadow-sm hover:shadow-2xl hover:border-[#D96B33] transition-all duration-500 flex flex-col justify-between group hover:-translate-y-1.5 scroll-mt-28"
              >
                ...
                <div className="relative h-56 overflow-hidden bg-[#18253A]">
                  ...
                  <div className="absolute top-4 left-4 z-10">
                    <span className="text-[10px] font-mono bg-[#18253A]/80 backdrop-blur-md text-[#D96B33] border border-[#A49050]/40 px-3 py-1 rounded font-bold uppercase tracking-widest">
                ...
                <div className="p-6 flex flex-col flex-1 justify-between gap-6">
                  ...
                  <div className="pt-4 border-t border-gray-100 flex items-center gap-3">
                    <button
                      ...
                      className="flex-1 bg-[#18253A] hover:bg-[#1E2D44] text-white py-2.5 px-4 text-xs font-mono font-bold tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-2 rounded-md shadow hover:shadow-md group-hover:bg-[#D96B33]"
                    >
                      <Eye className="w-3.5 h-3.5 text-[#D96B33] group-hover:text-white transition-colors" />
          ...
          <div className="bg-white w-full max-w-6xl md:h-[85vh] max-h-[92vh] rounded-3xl shadow-2xl relative flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="flex-1 min-h-0 flex flex-col">
              <div className="service-modal-content-panel modal-scroll flex-1 overflow-y-auto p-6 sm:p-10 flex flex-col gap-6">
                <div>
                  <span className="inline-flex w-fit items-center text-xs font-medium text-[#A49050] bg-[#A49050]/10 border border-[#A49050]/30 px-3 py-1.5 rounded-full mb-3">
                    Service
                  </span>
                  <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#18253A] leading-tight">
                    {selectedService.title}
                  </h3>
                  <p className="text-[#18253A]/70 text-sm sm:text-base mt-2 leading-relaxed">
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <p className="text-sm text-[#18253A]/75 leading-relaxed">{selectedService.description}</p>
                </div>
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <ul className="space-y-1.5 text-sm text-[#18253A]/75">
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <p className="text-sm text-[#18253A]/75 leading-relaxed bg-[#F1F3F5] border-l-3 border-[#A49050] p-3.5 rounded-xs">
              ...
              <div className="flex items-center justify-end gap-3 px-6 sm:px-10 py-5 border-t border-gray-100 bg-[#F1F3F5]/50 shrink-0">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-[#A49050] hover:bg-[#8A7942] text-white text-sm font-semibold rounded-full shadow-md hover:shadow-lg flex items-center gap-2 transition-all hover:-translate-y-0.5 active:translate-y-0"
                >
                  <Download className="w-4 h-4" />
