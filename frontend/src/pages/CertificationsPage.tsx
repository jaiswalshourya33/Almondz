...
export const CertificationsPage: React.FC = () => {
  ...
  return (
    <div className="about-dropdown-page flex flex-col min-h-screen bg-[#F1F3F5] pt-24">
              ...
              >
                ...
                <div className="pt-6 mt-6 border-t border-gray-100">
                  <button
                    ...
                    className="w-full bg-[#2A4C72] hover:bg-[#1E2D44] text-white py-2.5 px-4 text-xs font-mono font-bold tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-2 rounded-md shadow hover:shadow-md cursor-pointer"
                  >
      ...
      <section className="pt-10 pb-20 bg-[#2A4C72]/5 border-t border-[#A49050]/20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={empanelmentsHeaderRef} className="empanelments-header text-center max-w-3xl mx-auto mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-[#2A4C72] mt-1">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-white border border-[#A49050] w-full max-w-3xl max-h-[90vh] overflow-y-auto p-8 shadow-2xl relative rounded-md flex flex-col gap-6">
            <button
              ...
              className="absolute top-4 right-4 p-2 text-gray-500 hover:text-[#2A4C72] bg-gray-100 hover:bg-gray-200 transition-colors rounded-md cursor-pointer"
            ...
            <div className="flex items-center justify-end pt-4 border-t border-gray-100">
              <button
                onClick={() => setSelectedCert(null)}
                className="px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-[#2A4C72] text-xs font-mono font-bold tracking-wider uppercase transition-colors rounded-md cursor-pointer"
              >
                Close Preview
              </button>
            </div>
