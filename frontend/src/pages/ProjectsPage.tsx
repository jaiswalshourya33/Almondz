  ...
  return (
    <div className="dropdown-content-page flex flex-col min-h-screen bg-[#F1F3F5] pt-24">
      ...
      <section 
        ...
        className="projects-hero-statement relative -mt-24 min-h-[560px] sm:min-h-[640px] flex items-center justify-center pt-52 pb-16 sm:pt-60 sm:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#2A4C72]"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full bg-[#F1F3F5] border border-[#A49050]/30 pl-10 pr-4 py-2 text-xs text-[#2A4C72] placeholder-gray-500 focus:outline-none focus:border-[#D96B33] rounded-md"
            />
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {filteredProjects.length === 0 ? (
            <div className="text-center py-20 bg-white border border-[#A49050]/30 rounded-lg">
              <h3 className="text-xl font-serif text-[#2A4C72]">No projects found matching your criteria.</h3>
