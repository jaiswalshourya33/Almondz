...
export const ManagementTeamPage: React.FC = () => {
  ...
  return (
    <div className="about-dropdown-page flex flex-col min-h-screen bg-[#F1F3F5] pt-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-between items-stretch lg:items-center mb-12 bg-white rounded-2xl border border-[#A49050]/15 shadow-sm p-3">
            ...
            <div className="relative min-w-[260px]">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-[#F1F3F5] border border-transparent rounded-full text-xs text-[#2B4A6D] placeholder-gray-400 focus:outline-none focus:border-[#D96B33] focus:bg-white transition-all"
              />
              {searchQuery && (
                <button
              ...
              {paginatedMembers.map((member) => (
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#F1F3F5]">
                    ...
                    />
                    <span className="absolute top-2.5 left-2.5 text-[9px] font-mono uppercase tracking-widest text-white bg-[#2B4A6D]/85 backdrop-blur-sm px-2 py-0.5 rounded-full border border-white/10">
                      {member.department ?? 'Management'}
                    </span>
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#2B4A6D]/85 to-transparent px-3 pb-2 pt-8 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <div className="p-3.5 flex flex-col gap-0.5">
                    <h3 className="text-base font-serif font-bold text-[#2B4A6D] leading-snug group-hover:text-[#D96B33] transition-colors">
                      {member.name}
                    </h3>
                    ...
                    {(member.competencies?.length ?? 0) > 0 && (
                      <div className="flex flex-wrap gap-1.5 mt-2 pt-2 border-t border-gray-100">
                        {member.competencies!.slice(0, 3).map((comp, idx) => (
                          <span key={idx} className="text-[10px] font-medium bg-[#2B4A6D] text-white px-2 py-1 rounded-full">
                            {comp}
                          </span>
                        ))}
          ...
          {filteredMembers.length === 0 && (
            <div className="text-center py-20 bg-white border border-[#A49050]/30 p-8">
              ...
              <h3 className="text-lg font-serif font-bold text-[#2B4A6D]">No management team members found</h3>
              ...
              <button
                ...
                className="mt-4 px-4 py-2 bg-[#2B4A6D] text-white text-xs font-mono hover:bg-[#D96B33] transition-colors"
              >
                Reset Filters
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={governanceBannerRef} className="gov-banner relative rounded-lg shadow-xl overflow-hidden">
            ...
            <img
              ...
              referrerPolicy="no-referrer"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#2B4A6D]/15 via-transparent to-transparent" />
            ...
            <div className="relative m-5 sm:m-8 lg:m-10">
              ...
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-serif font-bold text-[#2B4A6D] mt-2">Pillars of Management Leadership</h2>
              ...
              <div className="flex flex-col gap-4">
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-[#2B4A6D]/70 leading-relaxed">
      ...
      {activeModalMember && (
        <div
          className="fixed inset-0 z-50 overflow-y-auto bg-[#2B4A6D]/70 backdrop-blur-sm p-4 sm:p-10 animate-fade-in"
            ...
            <div className="flex-1 flex flex-col">
              <div className="leader-modal-content-panel flex-1 p-6 sm:p-8 flex flex-col gap-4">
                <div>
                  ...
                  <h2 className="text-2xl sm:text-3xl font-serif font-bold text-[#2B4A6D] leading-tight">
              ...
              <div className="flex items-center justify-between gap-3 px-6 sm:px-8 py-5 border-t border-gray-100 bg-[#F1F3F5]/50 shrink-0">
                ...
                <button
                  onClick={() => setActiveModalMember(null)}
                  className="px-5 py-2.5 text-sm font-medium text-[#2B4A6D] hover:bg-gray-100 rounded-full transition-colors"
                >
                  Close
                </button>
              </div>
