...
export const ServiceDetail: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-[#fdf9ed] pt-32 pb-20 text-center px-4">
        <div className="max-w-md mx-auto bg-white p-8 border border-[#A49150]/30 shadow-xl rounded-md">
          <div className="w-16 h-16 bg-[#16283D] text-[#F2834C] mx-auto flex items-center justify-center rounded-full mb-4">
            <Building2 className="w-8 h-8" />
          </div>
          <h2 className="text-2xl font-serif font-bold text-[#16283D]">Service Dossier Not Found</h2>
          ...
          <Link to="/services" className="inline-block bg-[#16283D] hover:bg-[#F2834C] text-white px-6 py-3 text-xs font-mono font-bold tracking-widest uppercase shadow-md hover:shadow-lg transition-all duration-300 rounded-md">
  ...
  return (
    <div className="dropdown-content-page flex flex-col min-h-screen bg-[#fdf9ed] pt-24">
      ...
      {/* Hero Header */}
      <section className="relative py-20 lg:py-28 bg-[#16283D] text-white overflow-hidden border-b border-[#A49150]/30">
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 text-xs font-mono font-bold uppercase transition-all whitespace-nowrap rounded-md ${
                    isActive 
                      ? 'bg-[#16283D] text-white shadow-md border border-[#A49150]/40' 
                      : 'bg-white text-[#16283D] hover:bg-[#A49150]/10 border border-[#A49150]/20'
                  }`}
                >
              ...
              {activeTab === 'overview' && (
                <div className="bg-white border border-[#A49150]/30 p-8 sm:p-10 shadow-sm rounded-lg animate-fade-in space-y-6">
                  <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
                    <div className="w-10 h-10 bg-[#16283D] text-[#F2834C] flex items-center justify-center rounded-md font-bold font-mono">
                      01
                    </div>
                    <div>
                      <span className="text-[10px] font-mono text-[#F2834C] uppercase tracking-widest font-bold">PRACTICE OVERVIEW</span>
                      <h3 className="text-2xl font-serif font-bold text-[#16283D]">Comprehensive Scope & Objectives</h3>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#fdf9ed] p-6 border border-[#A49150]/30 rounded-md space-y-4">
                    <h4 className="text-xs font-mono font-bold text-[#16283D] uppercase tracking-wider flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                    <div className="p-4 bg-gray-50 rounded-md border border-gray-200">
                      ...
                      <span className="text-sm font-bold text-[#16283D] font-serif">100% Independent & Objective</span>
                    </div>
                    <div className="p-4 bg-gray-50 rounded-md border border-gray-200">
                      <span className="text-xs font-mono text-gray-500 block uppercase">Industry Benchmark</span>
                      <span className="text-sm font-bold text-[#16283D] font-serif">Aligned with IRC & IS Codes</span>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="bg-white border border-[#A49150]/30 p-8 sm:p-10 shadow-sm rounded-lg animate-fade-in space-y-6">
                  <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-serif font-bold text-[#16283D]">Key Deliverables & Reports</h3>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {service.deliverables.map((item, idx) => (
                      <div key={idx} className="flex items-start gap-3.5 p-5 bg-[#fdf9ed] border border-[#A49150]/30 rounded-md hover:border-[#F2834C] transition-colors shadow-sm">
                        <div className="w-6 h-6 rounded-full bg-[#16283D] text-[#F2834C] flex items-center justify-center shrink-0 mt-0.5 font-mono text-xs font-bold">
                          {idx + 1}
                        </div>
                        <div>
                          <h4 className="text-xs font-mono font-bold text-[#16283D] mb-1">Deliverable #{idx + 1}</h4>
                ...
                <div className="bg-white border border-[#A49150]/30 p-8 sm:p-10 shadow-sm rounded-lg animate-fade-in space-y-6">
                  <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-serif font-bold text-[#16283D]">Execution Methodology</h3>
                    </div>
                  </div>

                  <div className="bg-[#16283D] text-white p-6 sm:p-8 rounded-lg border border-[#A49150]/40 shadow-md space-y-4">
                  ...
                  <div className="space-y-3">
                    <h4 className="text-xs font-mono font-bold text-[#16283D] uppercase tracking-wider">Step-by-Step Engagement Protocol</h4>
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={sIdx} className="flex items-center gap-3 p-4 bg-gray-50 rounded-md border border-gray-200">
                          ...
                          <span className="text-xs font-medium text-[#16283D]">{step}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="bg-white border border-[#A49150]/30 p-8 sm:p-10 shadow-sm rounded-lg animate-fade-in space-y-6">
                  <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-serif font-bold text-[#16283D]">Compliance & Accreditations</h3>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                    <div className="bg-[#fdf9ed] p-5 border border-[#A49150]/30 rounded-md text-center">
                      ...
                      <h4 className="text-xs font-mono font-bold text-[#16283D]">ISO 9001:2015</h4>
                      <p className="text-[11px] text-gray-600 mt-1">Certified Quality Systems</p>
                    </div>
                    <div className="bg-[#fdf9ed] p-5 border border-[#A49150]/30 rounded-md text-center">
                      <Award className="w-8 h-8 text-[#F2834C] mx-auto mb-2" />
                      <h4 className="text-xs font-mono font-bold text-[#16283D]">Statutory Audit</h4>
                    ...
                    <div className="bg-[#fdf9ed] p-5 border border-[#A49150]/30 rounded-md text-center">
                      ...
                      <h4 className="text-xs font-mono font-bold text-[#16283D]">Panel Recognition</h4>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6 sticky top-28">
              ...
              <div className="bg-white border border-[#A49150]/30 p-6 sm:p-8 shadow-sm rounded-lg flex flex-col gap-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-base font-serif font-bold text-[#16283D]">Engage Our Specialists</h4>
                ...
                <div className="space-y-3 pt-2">
                  <Link 
                    to="/contact" 
                    className="w-full bg-[#16283D] hover:bg-[#F2834C] text-white py-3.5 px-4 text-center text-xs font-mono font-bold tracking-widest uppercase transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 rounded-md"
                  >
                  ...
                  <button
                    onClick={() => handleDownload(service.title)}
                    className="w-full bg-[#fdf9ed] hover:bg-[#A49150]/20 text-[#16283D] border border-[#A49150]/30 py-3.5 px-4 text-center text-xs font-mono font-bold tracking-widest uppercase transition-all duration-300 flex items-center justify-center gap-2 rounded-md"
                  >
                    <Download className="w-4 h-4" />
              ...
              {/* Related Services */}
              <div className="bg-[#16283D] text-white p-6 sm:p-8 rounded-lg border border-[#A49150]/30 shadow-md">
