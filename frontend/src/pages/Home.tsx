...
export const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F1F3F5]">
      ...
      {/* HERO SECTION */}
      <section className="projects-hero-statement is-visible relative group min-h-[92vh] flex items-center justify-center bg-[#2B4A6D] text-white overflow-hidden pt-28 pb-16">
      ...
      <section className="py-14 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-serif font-bold text-[#2B4A6D] mt-1">Delivered Value Across India's Infrastructure Sectors</h2>
          </div>
        </div>
                ...
                <button
                  ...
                  className={`shrink-0 whitespace-nowrap rounded-full border px-3 py-1.5 text-[11px] sm:text-xs font-mono font-bold uppercase tracking-wider transition-colors duration-200 ${
                    activeSectorIndex === index
                      ? 'bg-[#2B4A6D] border-[#2B4A6D] text-white'
                      : 'bg-white border-[#2B4A6D]/15 text-[#2B4A6D]/70 hover:bg-[#3E4C60] hover:border-[#3E4C60] hover:text-white'
                  }`}
                >
          ...
          <div ref={sectorTrackRef} className="sector-showcase" aria-label="Specialized infrastructure sectors">
            {SECTORS.map((sector, index) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#101A29] via-[#2B4A6D]/40 to-[#2B4A6D]/10" />
      ...
      <section
        ...
        className="brand-statement relative min-h-[460px] sm:min-h-[540px] flex items-center justify-center py-20 sm:py-28 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#2B4A6D]"
      >
      ...
      <section ref={lifecycleSectionRef} className="lifecycle-showcase relative py-16 sm:py-20 text-white overflow-hidden bg-[#101A29]">
        ...
        <div className="absolute inset-0 z-0">
          <img
            ...
            className="w-full h-full object-cover object-center"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#101A29]/55 via-[#2B4A6D]/40 to-[#101A29]/60 backdrop-brightness-[0.9]"></div>
        </div>
            ...
            {LIFECYCLE_STAGES.map((stage, idx) => {
              ...
              return (
                <div
                  ...
                  className={`lifecycle-showcase__card relative z-10 w-full bg-white border border-[#2B4A6D]/10 rounded-2xl shadow-md p-2.5 sm:p-3 group transition-all duration-300 lg:w-[310px] ${
