      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10 lg:gap-14">
        ...
        <div ref={row1Ref} className="scope-row grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-stretch">
          <div className="scope-card lg:col-span-7 bg-white border border-[#A49050]/15 rounded-2xl p-6 sm:p-7 shadow-[0_8px_30px_rgba(13,27,42,0.06)] flex flex-col justify-between">
            <div>
              <h3 className="scope-reveal text-xl sm:text-2xl font-serif font-bold text-[#2A4C72]" style={{ ['--i' as string]: 0 }}>
                Services &amp; Scope of Work
              </h3>
              <div className="scope-reveal w-12 h-0.5 bg-[#A49050] rounded-full mt-2 mb-4" style={{ ['--i' as string]: 1 }} />
              <p className="scope-reveal text-xs sm:text-[13.5px] text-[#2A4C72]/75 leading-relaxed mb-5" style={{ ['--i' as string]: 2 }}>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-0.5">
                  {sector.services.map((srv, idx) => (
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-[13px] font-medium text-[#2A4C72]/85 leading-snug group-hover:text-[#2A4C72] transition-colors">
                        {srv}
                      </span>
                    </li>
                  ))}
            ...
            <div
              className="scope-reveal mt-5 pt-3.5 border-t border-[#A49050]/15 flex flex-col sm:flex-row sm:items-center justify-between text-[11px] text-[#2A4C72]/55 gap-1.5"
              style={{ ['--i' as string]: 4 }}
            >
              <span>
                Sector Domain: <strong className="text-[#2A4C72]/80 font-semibold">{sector.title}</strong>
              </span>
          ...
          <div className="relative m-4 sm:m-6 lg:m-8 flex justify-end">
            <div className="gov-banner__card gov-banner__card--right w-full max-w-2xl bg-white rounded-2xl shadow-2xl ring-1 ring-black/5 border-t-4 border-[#A49050] p-6 sm:p-8 flex flex-col gap-4">
              <div>
                ...
                <h4 className="text-2xl sm:text-3xl font-serif font-bold text-[#2A4C72] mt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-[#A49050]/15">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <span className="text-[9px] text-[#2A4C72]/45 uppercase font-semibold tracking-wide block">
                      Email Inquiry
                    </span>
                    <a
                      href="mailto:info@almondz.com"
                      className="text-xs font-medium text-[#2A4C72] hover:text-[#A49050] transition-colors"
                    >
                      info@almondz.com
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-medium text-[#2A4C72]">+91 11 4350 0100</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-medium text-[#2A4C72]">New Delhi, India</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 bg-[#2A4C72] hover:bg-[#3E4C60] hover:text-[#D6C489] text-white py-3 px-6 text-xs font-bold uppercase tracking-wider transition-all duration-200 rounded-lg shadow-md w-fit"
                >
