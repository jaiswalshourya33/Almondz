  ...
  return (
    <div ref={containerRef} className="w-full my-8">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        ...
        <span className="text-[11px] font-mono uppercase tracking-[0.2em] text-[#2B4A6D]/50">
            ...
            {visibleFilings.map((filing, i) => (
              ...
              >
                <div className="flex items-center gap-4 sm:gap-6 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-3 flex-wrap">
                      <h3 className="text-xl sm:text-2xl font-serif font-bold text-[#2B4A6D] group-hover:text-[#A49050] transition-colors leading-tight">
                        {filing.period}
                      </h3>
                    ...
                    <p className="text-[11px] sm:text-xs text-[#2B4A6D]/55 mt-1 font-mono uppercase tracking-wider flex items-center gap-2">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="shrink-0 inline-flex items-center gap-2.5 bg-gradient-to-r from-[#2B4A6D] to-[#2C3E50] hover:from-[#A49050] hover:to-[#8C7A3E] text-white px-5 sm:px-7 py-3.5 text-xs font-mono font-bold tracking-widest uppercase rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
