                ...
                <div key={year.period} className="relative pl-8 sm:pl-12">
                  ...
                  <div className="relative bg-gradient-to-r from-white via-[#FCFAF5] to-[#FAF5EB] border border-[#A49050]/30 rounded-2xl p-4 sm:p-5 shadow-[0_4px_16px_rgba(164,144,80,0.08)] mb-4 flex items-center justify-between gap-4 flex-wrap">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="text-xl sm:text-2xl font-serif font-bold text-[#2B4A6D]">
                        {year.period}
                      </h4>
                    </div>
                      ...
                      >
                        ...
                        {onSelectNotice && (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="shrink-0 inline-flex items-center gap-2 bg-gradient-to-r from-[#2B4A6D] to-[#2C3E50] hover:from-[#A49050] hover:to-[#8C7A3E] text-white px-4 sm:px-5 py-2.5 text-[11px] font-mono font-bold tracking-widest uppercase rounded-xl shadow-xs transition-all duration-300"
                          >
