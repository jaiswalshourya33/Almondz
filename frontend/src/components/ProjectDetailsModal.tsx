      ...
      <div className="relative w-full max-w-4xl max-h-[92vh] bg-white border border-gray-300 shadow-2xl overflow-hidden z-10 rounded-sm flex flex-col">
        ...
        >
          ...
          <div className="bg-[#FAF9F5]/70 p-3 sm:p-3.5 rounded-lg border border-[#A49050]/20 shadow-2xs">
            ...
            <h2 className="text-[11.5px] sm:text-xs md:text-[13px] font-serif font-bold text-[#2B4A6D] leading-snug">
              {project.title}
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-y-1 gap-x-3 text-[10.5px] sm:text-[11.5px] text-gray-600 mt-2 pt-2 border-t border-[#A49050]/15 font-medium">
              ...
              <span className="flex items-center gap-1.5">
                <Building2 className="w-3 h-3 text-[#2B4A6D] shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-2 items-stretch">
            ...
            <div className="md:col-span-7 flex flex-col h-full">
              <div className="border border-gray-200 rounded-sm overflow-hidden bg-white shadow-sm h-full flex flex-col">
                <div className="bg-gray-100 px-3.5 py-2.5 text-xs font-bold text-[#2B4A6D] uppercase tracking-wider border-b border-gray-200 shrink-0">
