    ...
    <section className="pt-16 pb-12 bg-[#F1F3F5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-[#2B4A6D] mt-2">Services We Provide</h2>
        </div>
        ...
        >
          ...
          <Link
            ...
            className="services-spotlight__media group relative block overflow-hidden rounded-2xl shadow-[0_14px_36px_rgba(13,27,42,0.18)] ring-1 ring-[#2B4A6D]/10 min-h-[380px] h-full"
          ...
          <ul className="services-spotlight__list flex flex-col justify-between border-y border-[#2B4A6D]/10 divide-y divide-[#2B4A6D]/10 lg:border-none lg:divide-y-0 lg:gap-1.5">
            {SERVICES.map((service, index) => {
