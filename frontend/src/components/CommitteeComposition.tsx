            ...
            return (
              <motion.button
                ...
                className={`relative text-left rounded-2xl p-4 lg:p-5 transition-all duration-300 snap-start shrink-0 lg:shrink min-w-[240px] lg:min-w-0 border ${
                  isActive
                    ? 'border-[#A49050]/40 shadow-[0_12px_32px_-8px_rgba(164,144,80,0.22),0_4px_12px_rgba(164,144,80,0.08)] text-[#2B4A6D]'
                    : 'bg-white/80 backdrop-blur-sm border-[#A49050]/20 hover:border-[#A49050]/40 hover:bg-white hover:shadow-md text-[#2B4A6D]/80'
                }`}
              >
                ...
                <div className="relative z-10 flex flex-col justify-between h-full">
                  ...
                  <h4
                    className={`mt-2 font-serif font-bold text-base lg:text-[17px] leading-snug transition-colors ${
                      isActive ? 'text-[#2B4A6D]' : 'text-[#2B4A6D]/90'
                    }`}
                  >
                    {committee.name}
                  </h4>
                  ...
                  <div className="mt-3 flex items-center justify-between pt-2.5 border-t border-[#A49050]/15">
                    <span className="text-[11px] font-mono uppercase tracking-wider text-[#2B4A6D]/60 flex items-center gap-1.5">
            ...
            >
              ...
              <div className="relative pb-6 border-b border-[#A49050]/20">
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  ...
                  <span className="text-[11px] font-mono text-[#2B4A6D]/50 tracking-wider flex items-center gap-1.5">
                    <ShieldCheck className="w-4 h-4 text-[#A49050]" />
                    Statutory Board Governance
                  </span>
                </div>

                <h3 className="gsap-committee-title mt-3 text-2xl sm:text-3xl font-serif font-bold text-[#2B4A6D] tracking-tight">
              ...
              <div className="mt-6">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-[11px] font-mono uppercase tracking-[0.2em] font-semibold text-[#2B4A6D]/50">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-4 min-w-0">
                          ...
                          <div
                            className={`shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-sm tracking-wider shadow-sm transition-transform duration-300 group-hover:scale-105 ${
                              isLead
                                ...
                                : 'bg-gradient-to-br from-[#F8FAFC] to-[#F1F3F5] text-[#2B4A6D] border border-[#A49050]/25'
                            }`}
                          >
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                              <h5 className="text-base sm:text-[17px] font-serif font-bold text-[#2B4A6D] group-hover:text-[#A49050] transition-colors truncate">
                                {member.name}
                              </h5>
                            </div>
                            ...
                            <div className="mt-1 flex items-center gap-2 flex-wrap">
                              <span
                                className={`text-[11px] font-mono font-semibold uppercase tracking-[0.16em] ${
                                  isLead ? 'text-[#A49050]' : 'text-[#2B4A6D]/60'
                                }`}
                              >
                                {member.role}
                              </span>
                        ...
                        {isLead ? (
                          ...
                          <div className="shrink-0 text-[#2B4A6D]/30 group-hover:text-[#A49050]/60 transition-colors">
