...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#1E3A5F] text-white pt-8 pb-5 border-t border-[#A49150]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 pb-6 border-b border-white/10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5 text-xs font-mono text-white/60">
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-[#A49150] shrink-0 mt-0.5" />
                <span>Registered & Corporate Office: F-33/3, Okhla Industrial Area, Phase-II, New Delhi-110020, INDIA</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-[#A49150] shrink-0" />
                <span>contact@almondzglobalinfra.com</span>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white/5 hover:bg-[#A49150] flex items-center justify-center text-white transition-all duration-300 hover:-translate-y-0.5" aria-label="LinkedIn">
                <Linkedin className="w-3.5 h-3.5" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white/5 hover:bg-[#A49150] flex items-center justify-center text-white transition-all duration-300 hover:-translate-y-0.5" aria-label="YouTube">
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-xs font-mono tracking-widest text-[#A49150] uppercase">COMPANY</h4>
          ...
          {/* Col 3: Expertise */}
          <div className="flex flex-col gap-2">
            <h4 className="text-xs font-mono tracking-widest text-[#A49150] uppercase">EXPERTISE</h4>
            <ul className="flex flex-col gap-1.5 text-sm">
          ...
          {/* Col 4: Newsletter */}
          <div className="flex flex-col gap-2">
            <h4 className="text-xs font-mono tracking-widest text-[#A49150] uppercase">STAY INFORMED</h4>
            ...
            <form onSubmit={(e) => { e.preventDefault(); alert("Thank you for subscribing to Almondz Infrastructure Insights."); }}>
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-white/5 border border-white/20 px-4 py-2.5 text-xs text-white placeholder-white/40 focus:outline-none focus:border-[#A49150] focus:bg-white/10 rounded-full pr-11 transition-colors"
                />
                <button type="submit" className="absolute right-1 top-1 bottom-1 w-8 rounded-full bg-[#A49150] hover:bg-[#8b7b44] text-white flex items-center justify-center transition-colors" aria-label="Subscribe">
                  <ArrowRight className="w-3.5 h-3.5" />
                </button>
              </div>
            </form>
            <div className="text-[11px] font-mono text-white/50 pt-0.5">
        ...
        {/* Bottom Bar */}
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-between text-xs text-white/50 font-mono gap-3">
          <div>
