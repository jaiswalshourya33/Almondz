...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#2B4A6D] text-white pt-8 pb-5 border-t border-[#A49050]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 pb-6 border-b border-white/10">
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-xs font-mono tracking-widest text-[#A49050] uppercase">COMPANY</h4>
          ...
          {/* Col 3: Expertise */}
          <div className="flex flex-col gap-2">
            <h4 className="text-xs font-mono tracking-widest text-[#A49050] uppercase">EXPERTISE</h4>
            <ul className="flex flex-col gap-1.5 text-sm">
          ...
          {/* Col 4: Newsletter */}
          <div className="flex flex-col gap-2">
            <h4 className="text-xs font-mono tracking-widest text-[#A49050] uppercase">STAY INFORMED</h4>
            ...
            <form onSubmit={(e) => { e.preventDefault(); alert("Thank you for subscribing to Almondz Infrastructure Insights."); }}>
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-white/5 border border-white/20 px-4 py-2.5 text-xs text-white placeholder-white/40 focus:outline-none focus:border-[#A49050] focus:bg-white/10 rounded-full pr-11 transition-colors"
                />
                <button type="submit" className="absolute right-1 top-1 bottom-1 w-8 rounded-full bg-[#A49050] hover:bg-[#8A7942] text-white flex items-center justify-center transition-colors" aria-label="Subscribe">
